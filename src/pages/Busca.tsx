...
import type { Produto, ProdutosPorCategoria } from "@/types/products";
...
export default function Busca() {
  ...
  const produtos = ProdutosJSON as ProdutosPorCategoria;
  const todosProdutos: Produto[] = Object.values(produtos).flat();
    ...
    <Container className="mt-4">
      ...
      {resultados.length === 0 ? (
        ...
        <Row xs={1} md={3} className="g-4">
          {resultados.map((produto: Produto) => (
            <Col key={produto.id}>
              <Card>
