...
import type { ProdutosPorCategoria, Produto } from "@/types/products";

export default function Produtos() {
  const produtos: ProdutosPorCategoria = ProdutosJSON;
  const dispatch = useDispatch();

  function formatarTitulo(text: string) {
    return text
      .replace(/([A-Z])/g, " $1")
              ...
              {listaProdutos.map((produto) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    {/* Preço */}
                    <div className="mb-4">
                      {produto["preco-antigo"] && produto["preco-antigo"] > produto.preco ? (
