...
describe("cartSlice", () => {
  ...
  it("should increment quantity when item already exists in cart", () => {
    const state = {
      items: [
        { id: 1, nome: "Arroz", preco: 22.9, img: "/arroz.jpg", quantidade: 1 },
      ],
    };
  ...
  it("should decrement quantity when item quantity is greater than 1", () => {
    const state = {
      items: [
        { id: 1, nome: "Arroz", preco: 22.9, img: "/arroz.jpg", quantidade: 3 },
      ],
    };
  ...
  it("should clear the cart", () => {
    const state = {
      items: [
        { id: 1, nome: "Arroz", preco: 22.9, img: "/arroz.jpg", quantidade: 2 },
      ],
    };
